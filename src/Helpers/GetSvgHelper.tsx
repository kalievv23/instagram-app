...
export const GetSvg = (svg: NavSvgs, isActive: boolean) => {
    switch (svg) {
        case NavSvgs.PROFILE:
            return <NavProfileImg src={profile} alt="profile" />
        case NavSvgs.MAIN:
            if (isActive) {
                return (
